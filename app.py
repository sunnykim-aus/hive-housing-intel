...
<div style="display:flex;align-items:center;justify-content:space-between;
    ...
    <div style="display:flex;align-items:center;gap:10px;">
        <div style="display:flex;align-items:center;gap:6px;">
            ...
            <span style="font-size:1.15em;font-weight:900;color:#f6c90e;
                         letter-spacing:1.5px;text-transform:uppercase;">HIVE</span>
        </div>
        <span style="color:#2a2a4e;font-size:1.2em;">|</span>
        <span style="font-size:0.82em;color:#aaa;font-weight:400;">Housing Intelligence &amp; Evidence</span>
    </div>
